...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
     <div class="wap-banner">
    	<p class="area-cur"><strong>首页-</strong><strong></strong><strong><a href="${pageContext.request.contextPath }/leaveOut_index">遗漏值</a>-</strong><span>排列五</span></p>
    </div>
    <h1>排列五</h1>
    <div class="wap-banner">
    <p>第${batchCode }期</p>
    ...
    <c:forEach items="${leaveOutList }" var="leaveOut" varStatus="leaveOutIndex">
   	...
   	<h2 class="goucai-title"><span class="red-ball-num">万位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
     ...
     <h2 class="goucai-title"><span class="red-ball-num">千位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
        <c:forEach var="item" varStatus="status" begin="0" end="9">
