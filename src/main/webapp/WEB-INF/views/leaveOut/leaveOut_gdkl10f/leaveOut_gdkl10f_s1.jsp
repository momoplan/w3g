...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
   <div class="wap-banner">
    ...
    <c:set var="leaveOut" value="${leaveOutList[0] }"></c:set>
   	<h2 class="goucai-title"><span class="red-ball-num">前一数投当前期遗漏值：</span></h2>
