...
<div class="wap-banner">
    ...
    <h2 class="goucai-title"><span class="red-ball-num">前位当前期遗漏值：</span></h2>
...
<c:forEach var="item" varStatus="status" begin="1" end="20">
    ...
    <h2 class="goucai-title"><span class="blue-ball-num">后位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="blueball-p">
