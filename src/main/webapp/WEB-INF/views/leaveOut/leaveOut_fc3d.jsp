...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
   <div class="wap-banner">
    	<p class="area-cur"><strong><a href="${pageContext.request.contextPath }">首页</a>-</strong><strong></strong><strong><a href="${pageContext.request.contextPath }/leaveOut_index">遗漏值</a>-</strong><span>福彩3D</span></p>
    </div>
    <h1>福彩3D</h1>
    <div class="wap-banner">
    <p>第${batchCode }期</p>
    ...
    <c:forEach items="${leaveOutList }" var="leaveOut" varStatus="leaveOutIndex">
    	<c:choose>
    		<c:when test="${leaveOutIndex.index==0 }">
    			 <h2 class="goucai-title"><span class="red-ball-num">福彩3D百位遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
    		...
    		<c:when test="${leaveOutIndex.index==1 }">
    			 <h2 class="goucai-title"><span class="red-ball-num">福彩3D十位遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
        	<c:forEach var="item" varStatus="status" begin="0" end="9">
    		...
    		<c:when test="${leaveOutIndex.index==2 }">
    			<h2 class="goucai-title"><span class="red-ball-num">福彩3D个位遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
        	<c:forEach var="item" varStatus="status" begin="0" end="9">
