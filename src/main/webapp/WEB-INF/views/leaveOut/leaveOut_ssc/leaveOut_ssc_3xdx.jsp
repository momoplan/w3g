...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
   <div class="wap-banner">
    ...
    <h5>三星：<a href="${pageContext.request.contextPath }/leaveOut/leaveOutDetail?lotNo=T01007&key=T01007MV_5X&type=SXZhX" class="tit-cur-h5">三星直选</a></h5>
    ...
    <h2 class="goucai-title"><span class="red-ball-num">三星直选百位当前期遗漏值：</span></h2>
    ...
    <h2 class="goucai-title"><span class="red-ball-num">三星直选十位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
        <c:forEach var="item" varStatus="status" begin="0" end="9">
    ...
    <h2 class="goucai-title"><span class="red-ball-num">三星直选个位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
