...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
  <div class="wap-banner">
    ...
    <h1><a>时时彩</a></h1>
   	<h5>五星：<a href="${pageContext.request.contextPath }/leaveOut/leaveOutDetail?lotNo=T01007&key=T01007MV_5X&type=WXZhX">五星直选</a><span>|</span><a href="${pageContext.request.contextPath }/leaveOut/leaveOutDetail?lotNo=T01007&key=T01007MV_5X&type=WXTX"  class="tit-cur-h5">五星通选</a></h5>
    ...
    <p>剩余时间：<em class="end-time">${remainingTime }</em></p>
        ...
        <form action="${pageContext.request.contextPath }/shiShiCai/byFiveStarToTongSelf" method="post">
   	...
   	<h2 class="goucai-title"><span class="red-ball-num">五星通选万位当前期遗漏值：</span></h2>
    ...
    <h2 class="goucai-title"><span class="red-ball-num">五星通选千位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
    ...
    <h2 class="goucai-title"><span class="red-ball-num">五星通选百位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
    ...
    <h2 class="goucai-title"><span class="red-ball-num">五星通选十位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
    ...
    <h2 class="goucai-title"><span class="red-ball-num">五星通选个位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
