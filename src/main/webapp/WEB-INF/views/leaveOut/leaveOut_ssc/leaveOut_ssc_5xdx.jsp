...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
  <div class="wap-banner">
    ...
    <h1><a>时时彩</a></h1>
   	<h5>五星：<a href="${pageContext.request.contextPath }/leaveOut/leaveOutDetail?lotNo=T01007&key=T01007MV_5X&type=WXZhX"  class="tit-cur-h5">五星直选</a><span>|</span><a href="${pageContext.request.contextPath }/leaveOut/leaveOutDetail?lotNo=T01007&key=T01007MV_5X&type=WXTX">五星通选</a></h5>
    ...
    <input name="batchCode" value="${batchCode }" type="hidden"/>
   	...
   	<h2 class="goucai-title"><span class="red-ball-num">五星直选万位当前期遗漏值：</span></h2>
    ...
    <h2 class="goucai-title"><span class="red-ball-num">五星直选千位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
    ...
    <h2 class="goucai-title"><span class="red-ball-num">五星直选百位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
    ...
    <h2 class="goucai-title"><span class="red-ball-num">五星直选十位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
    ...
    <h2 class="goucai-title"><span class="red-ball-num">五星直选个位当前期遗漏值：</span></h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p">
