...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
   ...
   <div class="xuxian-line"></div>
    ...
    <h2 class="goucai-title"><span class="red-ball-num">二星和值当前期遗漏值：</span></h2>
