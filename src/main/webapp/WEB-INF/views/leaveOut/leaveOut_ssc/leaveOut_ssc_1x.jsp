...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
   <div class="wap-banner">
    ...
    <h5>其它：<a href="${pageContext.request.contextPath }/leaveOut/leaveOutDetail?lotNo=T01007&key=T01007MV_DD&type=DXDS">大小单双</a><span>|</span><a href="${pageContext.request.contextPath }/leaveOut/leaveOutDetail?lotNo=T01007&key=T01007MV_5X&type=YX" class="tit-cur-h5">一星</a></h5>
    ...
    <h2 class="goucai-title"><span class="red-ball-num">一星个位当前期遗漏值：</span></h2>
