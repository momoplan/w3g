...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
     <div class="wap-banner">
    	<p class="area-cur"><strong><a href="${pageContext.request.contextPath }">首页</a>-</strong><strong></strong><strong><a href="${pageContext.request.contextPath }/leaveOut_index">遗漏值</a>-</strong><span>七乐彩</span></p>
    </div>
    <h1>七乐彩</h1>
    <div class="wap-banner">
    <p>第${batchCode }期</p>
    ...
    <form action="${pageContext.request.contextPath }/qiLeCai/byLottery" method="post">
   	<c:set var="leaveOut" value="${leaveOutList[0] }"></c:set>
    <h2 class="goucai-title"><span class="red-ball-num">七乐彩遗漏值：</span></h2>
    ...
    <input name="batchCode" value="${batchCode }" type="hidden"/>
     <div class="wap-pro-gray-goucai" style="border-top:1px solid #999; border-bottom:none">
            ...
            <p>追号：<input name="addNumber" type="text" class="num-ball" value="1" maxlength="2"/>期<input name="prizeend" type="checkbox" value="" style="width:12px; height:12px; vertical-align:middle; margin-left:30px;" />中奖后停止</p>
    </div>
