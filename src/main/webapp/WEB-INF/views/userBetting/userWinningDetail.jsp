...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
     ...
     <div class="wap-banner yellowline">
    	<p class="area-cur"><strong><a href="${pageContext.request.contextPath }">首页</a>-</strong><strong><a href="${pageContext.request.contextPath }/userCenter">用户中心</a>-</strong><span><a href="${pageContext.request.contextPath }/select/userWinning.do">中奖查询</a></span></p>
    </div>
