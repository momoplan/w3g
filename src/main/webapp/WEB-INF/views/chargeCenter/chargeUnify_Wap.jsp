...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <img src="${pageContext.request.contextPath }/images/LDYS.jpg" width="120" height="30" />
        <p class="noone">即时入账，无手续费</p>
        <p class="prompt-pro">${messageError }</p>
        <form action="${pageContext.request.contextPath }/chargeCenter/chargeUnify_Wap.do" method="post">
