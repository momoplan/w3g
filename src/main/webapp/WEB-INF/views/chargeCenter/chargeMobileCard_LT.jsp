...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h1><a>充值卡充值</a></h1>
   <div class="wap-pro-gray czhika"><a href="${pageContext.request.contextPath }/chargeMobileCard?type=YD">移动充值卡</a> | <a class="czhika-cur">联通充值卡</a> | <a href="${pageContext.request.contextPath }/chargeMobileCard?type=DX">电信充值卡</a></div>
    <div class="wap-pro">
      <p><img src="${pageContext.request.contextPath }/images/LT.png" width="120" height="30" /></p>
        <form action="${pageContext.request.contextPath }/chargeCenter/nineteenPayCardCharge.do" method="post">
        	...
        	<input name="cardType" type="hidden" value="LT"/>
