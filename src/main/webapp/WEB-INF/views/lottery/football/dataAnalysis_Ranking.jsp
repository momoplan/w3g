...
<h1><a class="tit-cur">排名</a><span>|</span><a href="${pageContext.request.contextPath }/footballIndex/selectDataAnalysisHistory?lotNo=${lotNo }&batchCode=${batchCode}&tempId=${tempId}&type=history_z10">历史</a><span>|</span><a href="${pageContext.request.contextPath }/footballIndex/selectDataAnalysisOuPei?lotNo=${lotNo }&batchCode=${batchCode}&tempId=${tempId}">欧指</a><span>|</span><a href="${pageContext.request.contextPath }/footballIndex/selectDataAnalysisYaPan?lotNo=${lotNo }&batchCode=${batchCode}&tempId=${tempId}">亚盘</a></h1>
