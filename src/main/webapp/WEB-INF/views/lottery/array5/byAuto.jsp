...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h1><a href="${pageContext.request.contextPath }/array5Index/bySelf">自选</a><span>|</span><a class="tit-cur">机选</a></h1>
    ...
    <form action="${pageContext.request.contextPath }/array5/byAuto" method="post">
