...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h3><a  href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byOptionThreeSelf"> 直选</a><span>|</span><a class="tittwo-cur">前三直选</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byForwardThreeGroupSelect">前三组选</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byOptionThreeDanTuo">胆拖</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byForwardThreeGroupSelectDanTuo">组选胆拖</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byOptionThreeAuto">机选</a></h3>
    <div class="wap-banner">
    	<p>10分钟一期，每天84期。</p>
        <p>剩余时间：<em class="end-time">${remainingTime }</em></p>
        <p class="prompt-pro">${messageError }</p>
    </div>
        <form action="${pageContext.request.contextPath }/guangDongElevenSelectFive/byForwardThreeDirectToSelect" method="post">
