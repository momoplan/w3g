...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h1><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byOptionOneSelf" >任一</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byOptionSixSelf">任二</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byOptionThreeSelf">任三</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byOptionFourSelf">任四</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byOptionFiveSelf">任五</a><span>|</span><a  class="tit-cur">任六</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byOptionSevenSelf">任七</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byOptionEightSelf">任八</a></h1>
    <h3><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byOptionSixSelf" > 直选</a><span>|</span><a class="tittwo-cur">胆拖</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongElevenSelectFiveIndex/byOptionSixAuto">机选</a></h3>
    <div class="wap-banner">
    	<p>10分钟一期，每天84期。</p>
    ...
    <h2 class="goucai-title"><span class="red-ball-num">选择胆码：</span>（选择1-5个号码）</h2>
    <div class="wap-pro-goucai">
...
<c:forEach var="item" varStatus="status" begin="1" end="11">
    ...
    <h2 class="goucai-title"><span class="red-ball-num">选择拖码：</span>（至少选择1个号码，12>胆+拖>6，胆、拖不重复）</h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p no-red">
<c:forEach var="item" varStatus="status" begin="1" end="11">
