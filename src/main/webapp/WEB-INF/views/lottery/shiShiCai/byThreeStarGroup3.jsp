...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
  <div class="wap-banner">
    ...
    <h3><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byThreeStarDirect"> 直选</a><span>|</span><a class="tittwo-cur">组三</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byThreeStarGroup6">组六</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byThreeStarAuto">机选</a></h3>
    <div class="wap-banner">
        ...
        <form action="${pageContext.request.contextPath }/shiShiCai/byThreeStarToGroup3" method="post">
   ...
   <div class="wap-pro-gray-goucai" style="border-top:1px solid #999; border-bottom:none">
    ...
    <p class="moneey-dlt">与开奖号的最后三位（即百、十、个位）相同中奖（不限顺序），单注奖金<span>320</span>元</p>
