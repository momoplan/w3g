...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h3><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byTwoStarDirect"> 直选</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byTwoStarGroup">组选</a><span>|</span><a class="tittwo-cur">和值</a></h3>
    <div class="wap-banner">
    ...
    <form action="${pageContext.request.contextPath }/shiShiCai/byTwoStarToHeZhi" method="post">
    ...
    <div class="wap-pro-goucai">
    	<p class="redball-p no-red">
        	<c:forEach var="item" varStatus="status" begin="0" end="18">
