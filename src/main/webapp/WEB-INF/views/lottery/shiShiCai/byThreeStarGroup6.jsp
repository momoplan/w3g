...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
   <div class="wap-banner">
    ...
    <h1><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byOneStarSelf">一星</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byTwoStarDirect">二星</a><span>|</span><a class="tit-cur">三星</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byFiveStarDirect">五星</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byDaXiaoDanShuangSelf">大小单双</a></h1>
    <h3><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byThreeStarDirect"> 直选</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byThreeStarGroup3">组三</a><span>|</span><a class="tittwo-cur">组六</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byThreeStarAuto">机选</a></h3>
    <div class="wap-banner">
       ...
       <form action="${pageContext.request.contextPath }/shiShiCai/byThreeStarToGroup6" method="post">
   ...
   <div class="wap-pro-gray-goucai" style="border-top:1px solid #999; border-bottom:none">
    ...
    <p class="moneey-dlt">与开奖号的最后三位（即百、十、个位）相同中奖（不限顺序），单注奖金<span>160</span>元</p>
