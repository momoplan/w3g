...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h3><a class="tittwo-cur"> 直选</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byTwoStarGroup">组选</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byTwoStarHeZhi">和值</a></h3>
    <div class="wap-banner">
   ...
   <div class="wap-pro-gray-goucai" style="border-top:1px solid #999; border-bottom:none">
    ...
    <p class="moneey-dlt">与开奖号的后两位（即十、个位）相同中奖，单注奖金<span>100</span>元</p>
