...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
   <div class="wap-banner">
    ...
    <h3><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byFiveStarDirect">五星</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byFiveStarTongSelf">五星通选</a><span>|</span><a class="tittwo-cur">机选</a></h3>
 ...
 <form action="${pageContext.request.contextPath }/shiShiCai/byFiveStarAuto" method="post">
