...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
  <div class="wap-banner">
    ...
    <h3><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byThreeStarDirect"> 直选</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byThreeStarGroup3">组三</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byThreeStarGroup6">组六</a><span>|</span><a class="tittwo-cur">机选</a></h3>
 ...
 <form action="${pageContext.request.contextPath }/shiShiCai/byThreeStarAuto" method="post">
