...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
  <div class="wap-banner">
    ...
    <h3><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byFiveStarDirect">五星</a><span>|</span><a class="tittwo-cur">五星通选</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byFiveStarAuto">机选</a></h3>
    <div class="wap-banner">
   ...
   <div class="wap-pro-gray-goucai" style="border-top:1px solid #999; border-bottom:none">
    ...
    <p class="moneey-dlt">与开奖号按位相符，即中<span>20000</span>元；首或尾连续三位与开奖号对应按位相符,即中二等奖<span>200</span>元；首或尾连续两位与开奖号对应按位相符,即中三等奖<span>20</span>元</p>
