...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h3><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byOneStarSelf">直选</a><span>|</span><a class="tittwo-cur">机选</a></h3>
 ...
 <form action="${pageContext.request.contextPath }/shiShiCai/byOneStarAuto" method="post">
    	...
    	<div class="wap-pro-gray-goucai" style="border-top:1px solid #999; border-bottom:none">
     		<p>倍数：<input name="beiShu" type="text" class="num-ball" value="${beiShu }" maxlength="45"/>（最多10000倍）</p>
