...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h3><a class="tittwo-cur"> 直选</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byThreeStarGroup3">组三</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byThreeStarGroup6">组六</a><span>|</span><a href="${pageContext.request.contextPath }/shiShiCaiIndex/byThreeStarAuto">机选</a></h3>
    <div class="wap-banner">
        ...
        <form action="${pageContext.request.contextPath }/shiShiCai/byThreeStarToDirect" method="post">
   ...
   <div class="wap-pro-gray-goucai" style="border-top:1px solid #999; border-bottom:none">
    ...
    <p class="moneey-dlt">与开奖号的后三位（即百、十、个位）相同即中奖，单注奖金<span>1000</span>元</p>
