...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
   <div class="wap-banner">
    	<p class="area-cur"><strong><a href="${pageContext.request.contextPath }">首页</a>-</strong><strong><a href="${pageContext.request.contextPath }/lotteryCenter">购彩大厅</a>-</strong><span>22选5</span></p>
    </div>
    <h1><a href="${pageContext.request.contextPath }/select5From22Index/bySelf">自选</a><span>|</span><a href="${pageContext.request.contextPath }/select5From22Index/byAuto">机选</a><span>|</span><a class="tit-cur">胆拖</a></h1>
    <div class="wap-banner">
    	<p>每日开奖，单注奖金最高500万！</p>
     ...
     <form action="${pageContext.request.contextPath }/select5From22/byDanTuo" method="post">
    ...
    <h2 class="goucai-title"><span class="red-ball-num">选择拖码：</span>（选择5-21个拖码，胆、拖不重复）</h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p no-red">
        	<c:forEach var="item" varStatus="status" begin="1" end="22">
