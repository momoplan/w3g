...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>    
    ...
    <h1><a href="${pageContext.request.contextPath }/fuCai3DIndex/byDirect">直选</a><span>|</span><a href="${pageContext.request.contextPath }/fuCai3DIndex/byAuto">机选</a><span>|</span><a href="${pageContext.request.contextPath }/fuCai3DIndex/byGroup3Self">组三</a><span>|</span><a class="tit-cur">组六</a><span>|</span><a href="${pageContext.request.contextPath }/fuCai3DIndex/byDirectHeZhi">和值</a><span>|</span><a href="${pageContext.request.contextPath }/fuCai3DIndex/byDanTuo">胆拖</a></h1>
    <div class="wap-banner">
    ...
    <form action="${pageContext.request.contextPath }/fuCai3D/byGroup6" method="post">
    ...
    <div class="wap-pro-goucai">
        ...
        <p><input name="ballNumber" type="text" class="num-ball" value="${ballNumber }" maxlength="2"/><input name="submitType" type="submit" value="机选号码" class="jx-redball" /></p>
    </div>
