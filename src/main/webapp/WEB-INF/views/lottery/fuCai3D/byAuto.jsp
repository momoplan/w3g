...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>    
    ...
    <h1><a href="${pageContext.request.contextPath }/fuCai3DIndex/byDirect">直选</a><span>|</span><a class="tit-cur">机选</a><span>|</span><a href="${pageContext.request.contextPath }/fuCai3DIndex/byGroup3Self">组三</a><span>|</span><a href="${pageContext.request.contextPath }/fuCai3DIndex/byGroup6Self">组六</a><span>|</span><a href="${pageContext.request.contextPath }/fuCai3DIndex/byDirectHeZhi">和值</a><span>|</span><a href="${pageContext.request.contextPath }/fuCai3DIndex/byDanTuo">胆拖</a></h1>
    ...
    <form action="${pageContext.request.contextPath }/fuCai3D/byAuto" method="post">
