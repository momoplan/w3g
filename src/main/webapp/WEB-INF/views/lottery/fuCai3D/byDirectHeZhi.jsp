...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>    
    ...
    <form action="${pageContext.request.contextPath }/fuCai3D/byHeZhi" method="post">
