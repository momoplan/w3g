...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
 <div class="wap-banner">
    ...
    <h3><a href="${pageContext.request.contextPath }/guangDongHappyTenMinutesIndex/bySelectOneNumberSelf" >前一数投</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongHappyTenMinutesIndex/bySelectOneNumberSingleAuto">数投机选</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongHappyTenMinutesIndex/bySelectOneRedSelf" class="tittwo-cur">前一红投</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongHappyTenMinutesIndex/bySelectOneRedSingleAuto">红投机选</a></h3>
    <div class="wap-banner">
    	<p>10分钟一期，每天84期。</p>
    ...
    <div class="wap-pro-goucai">
    	<p class="redball-p no-red">
    		<c:forEach var="item" varStatus="status" begin="19" end="20">
     ...
     <div class="wap-pro-gray-goucai" style="border-top:1px solid #999; border-bottom:none">
     	<input name="ballType" value="H1" type="hidden"/>
    ...
    <p class="moneey-dlt">与第1位开奖号为19或20一致，奖金<span>5</span>元</p>
