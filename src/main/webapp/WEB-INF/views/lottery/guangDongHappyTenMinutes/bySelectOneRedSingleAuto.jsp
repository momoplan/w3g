...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
 ...
 <div class="wap-banner">
    ...
    <h3><a href="${pageContext.request.contextPath }/guangDongHappyTenMinutesIndex/bySelectOneNumberSelf" >前一数投</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongHappyTenMinutesIndex/bySelectOneNumberSingleAuto">数投机选</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongHappyTenMinutesIndex/bySelectOneRedSelf">前一红投</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongHappyTenMinutesIndex/bySelectOneRedAuto" class="tittwo-cur">红投机选</a></h3>
