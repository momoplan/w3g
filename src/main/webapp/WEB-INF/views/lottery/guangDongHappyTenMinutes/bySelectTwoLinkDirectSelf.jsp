...
<div class="wap-banner">
    ...
    <h3><a href="${pageContext.request.contextPath }/guangDongHappyTenMinutesIndex/bySelectTwoLinkDirectSelf" class="tittwo-cur">直选</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongHappyTenMinutesIndex/bySelectTwoLinkDirectDanTuoSelf">胆拖</a><span>|</span><a href="${pageContext.request.contextPath }/guangDongHappyTenMinutesIndex/bySelectTwoLinkDirectSingleAuto">机选</a></h3>
    <div class="wap-banner">
    	<p>10分钟一期，每天84期。</p>
        <p>剩余时间：<em class="end-time">${remainingTime }</em></p>
        <p class="prompt-pro">${messageError }</p>
    </div>
               <form action="${pageContext.request.contextPath }/guangDongHappyTenMinutes/bySelectTwoLinkDirectToSelect" method="post">
...
<c:forEach var="item" varStatus="status" begin="1" end="20">
    ...
    <p class="moneey-dlt">与开奖号连续2位号码一致，奖金<span>62</span>元</p>
