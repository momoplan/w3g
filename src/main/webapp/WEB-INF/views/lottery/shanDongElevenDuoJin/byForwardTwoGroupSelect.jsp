...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
   <div class="wap-banner">
    ...
    <h1><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionOneSelf" >任一</a><span>|</span><a class="tit-cur">任二</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionThreeSelf">任三</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionFourSelf">任四</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionFiveSelf">任五</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionSixSelf">任六</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionSevenSelf">任七</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionEightSelf">任八</a></h1>
    <h3><a  href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionTwoSelf"> 直选</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byForwardTwoDirectSelect">前二直选</a><span>|</span><a class="tittwo-cur">前二组选</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionTwoDanTuo">胆拖</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byForwardTwoGroupSelectDanTuo">组选胆拖</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionTwoAuto">机选</a></h3>
    <div class="wap-banner">
    	<p>10分钟一期，每天78期。</p>
        <p>剩余时间：<em class="end-time">${remainingTime }</em></p>
        <p class="prompt-pro">${messageError }</p>
    </div>
        <form action="${pageContext.request.contextPath }/shanDongElevenDuoJin/byForwardTwoGroupToSelect" method="post">
    ...
    <div class="wap-pro-goucai">
     ...
     <div class="wap-pro-gray-goucai" style="border-top:1px solid #999; border-bottom:none">
     	<input name="ballType" value="Z2" type="hidden"/>
    ...
    <p class="moneey-dlt">与开奖号码的前两位一致（不限顺序）即中<span>65</span>元</p>
