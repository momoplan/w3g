...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h1><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionOneSelf" >任一</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionTwoSelf">任二</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionThreeSelf">任三</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionFourSelf">任四</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionFiveSelf">任五</a><span>|</span><a  class="tit-cur">任六</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionSevenSelf">任七</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionEightSelf">任八</a></h1>
    <h3><a class="tittwo-cur"> 直选</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionSixDanTuo">胆拖</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionSixAuto">机选</a></h3>
    <div class="wap-banner">
    	<p>10分钟一期，每天78期。</p>
    ...
    <h2 class="goucai-title"><span class="red-ball-num">选择号码：</span>（至少选择6个号码）</h2>
    <div class="wap-pro-goucai">
    ...
    <p class="moneey-dlt">任意5个与开奖号码一致即中<span>90</span>元</p>
