...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
   <div class="wap-banner">
    ...
    <h3><a class="tittwo-cur"> 直选</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionSevenDanTuo">胆拖</a><span>|</span><a href="${pageContext.request.contextPath }/shanDongElevenDuoJinIndex/byOptionSevenAuto">机选</a></h3>
    <div class="wap-banner">
    	<p>10分钟一期，每天78期。</p>
    ...
    <h2 class="goucai-title"><span class="red-ball-num">选择号码：</span>（至少选择7个号码）</h2>
    <div class="wap-pro-goucai">
    ...
    <p class="moneey-dlt">任意5个与开奖号码一致即中<span>26</span>元</p>
