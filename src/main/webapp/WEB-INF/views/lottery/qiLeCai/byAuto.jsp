...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h1><a href="${pageContext.request.contextPath }/qiLeCaiIndex/bySelf">自选</a><span>|</span><a class="tit-cur">机选</a><span>|</span><a href="${pageContext.request.contextPath }/qiLeCaiIndex/byDanTuo">胆拖</a></h1>
    ...
    <form action="${pageContext.request.contextPath }/qiLeCai/byAuto" method="post">
