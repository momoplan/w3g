...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h1><a class="tit-cur">自选</a><span>|</span><a href="${pageContext.request.contextPath }/qiLeCaiIndex/byAuto">机选</a><span>|</span><a href="${pageContext.request.contextPath }/qiLeCaiIndex/byDanTuo">胆拖</a></h1>
    <div class="wap-banner">
