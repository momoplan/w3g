...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h1><a href="${pageContext.request.contextPath }/array3Index/byDirect">直选</a><span>|</span><a class="tit-cur">机选</a><span>|</span><a href="${pageContext.request.contextPath }/array3Index/byGroup3Self">组三</a><span>|</span><a href="${pageContext.request.contextPath }/array3Index/byGroup6Self">组六</a><span>|</span><a href="${pageContext.request.contextPath }/array3Index/byDirectHeZhi">和值</a></h1>
	...
	<form action="${pageContext.request.contextPath }/array3/byAuto" method="post">
