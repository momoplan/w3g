...
<div class="wap-banner">
    ...
    <h1><a href="${pageContext.request.contextPath }/array3Index/byDirect">直选</a><span>|</span><a href="${pageContext.request.contextPath }/array3Index/byAuto">机选</a><span>|</span><a class="tit-cur">组三</a><span>|</span><a href="${pageContext.request.contextPath }/array3Index/byGroup6Self">组六</a><span>|</span><a href="${pageContext.request.contextPath }/array3Index/byDirectHeZhi">和值</a></h1>
    <div class="wap-banner">
    ...
    <form action="${pageContext.request.contextPath }/array3/byGroup3" method="post">
    ...
    <p class="moneey-dlt">所选号码与开奖号码一致(顺序不限)，且开奖号码有任意两位相同，奖金<span>320</span>元。</p>
