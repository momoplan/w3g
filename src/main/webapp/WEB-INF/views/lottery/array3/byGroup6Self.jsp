...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>    
    ...
    <h1><a href="${pageContext.request.contextPath }/array3Index/byDirect">直选</a><span>|</span><a href="${pageContext.request.contextPath }/array3Index/byAuto">机选</a><span>|</span><a href="${pageContext.request.contextPath }/array3Index/byGroup3Self">组三</a><span>|</span><a class="tit-cur">组六</a><span>|</span><a href="${pageContext.request.contextPath }/array3Index/byDirectHeZhi">和值</a></h1>
    <div class="wap-banner">
     ...
     <form action="${pageContext.request.contextPath }/array3/byGroup6" method="post">
    ...
    <div class="wap-pro-goucai">
        ...
        <p>机选<input name="ballNumber" type="text" class="num-ball" value="${ballNumber }" maxlength="2"/>个<input name="submitType" type="submit" value="机选号码" class="jx-redball" /></p>
    </div>
      <div class="wap-pro-gray-goucai" style="border-top:1px solid #999; border-bottom:none">
        ...
        <p class="moneey-dlt">所选号码与开奖号码相同（顺序不限）即中<span>160</span>元。</p>
