...
<h1><a href="${pageContext.request.contextPath }/jcFootballIndex/selectDataAnalysisRanking?day=${day }&weekId=${weekId}&teamId=${teamId}">排名</a><span>|</span><a class="tit-cur">历史</a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/selectDataAnalysisOuPei?day=${day }&weekId=${weekId}&teamId=${teamId}">欧指</a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/selectDataAnalysisYaPan?day=${day }&weekId=${weekId}&teamId=${teamId}">亚盘</a></h1>
 <c:choose>
 	<c:when test="${'history_z10' eq type }">
 		 <h3><a class="tittwo-cur">主队近10场 </a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/selectDataAnalysisHistory?day=${day }&weekId=${weekId}&teamId=${teamId}&type=history_k10">客队近10场</a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/selectDataAnalysisHistory?day=${day }&weekId=${weekId}&teamId=${teamId}&type=history_z5">主队未来5场 </a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/selectDataAnalysisHistory?day=${day }&weekId=${weekId}&teamId=${teamId}&type=history_k5">客队未来5场</a></h3>
 	</c:when>
 	<c:when test="${'history_k10' eq type }">
 		 <h3><a href="${pageContext.request.contextPath }/jcFootballIndex/selectDataAnalysisHistory?day=${day }&weekId=${weekId}&teamId=${teamId}&type=history_z10">主队近10场 </a><span>|</span><a class="tittwo-cur">客队近10场</a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/selectDataAnalysisHistory?day=${day }&weekId=${weekId}&teamId=${teamId}&type=history_z5">主队未来5场 </a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/selectDataAnalysisHistory?day=${day }&weekId=${weekId}&teamId=${teamId}&type=history_k5">客队未来5场</a></h3>
 	</c:when>
 	<c:when test="${'history_z5' eq type }">
 		 <h3><a href="${pageContext.request.contextPath }/jcFootballIndex/selectDataAnalysisHistory?day=${day }&weekId=${weekId}&teamId=${teamId}&type=history_z10">主队近10场 </a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/selectDataAnalysisHistory?day=${day }&weekId=${weekId}&teamId=${teamId}&type=history_k10">客队近10场</a><span>|</span><a class="tittwo-cur">主队未来5场 </a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/selectDataAnalysisHistory?day=${day }&weekId=${weekId}&teamId=${teamId}&type=history_k5">客队未来5场</a></h3>
 	</c:when>
