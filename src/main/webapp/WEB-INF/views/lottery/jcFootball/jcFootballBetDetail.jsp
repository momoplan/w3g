...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
   <div class="wap-banner">
    ...
    <c:choose>
    	<c:when test="${'FT001' eq wanFa }">
     		<h1><a class="tit-cur">胜平负</a><span>|</span><!-- <a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=J00013">让球胜平负</a><span>|</span> --><a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=FT002">比分</a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=FT003">总进球</a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=FT004">半全场</a></h1>
    	</c:when>
    	<c:when test="${'FT002' eq wanFa }">
    		<h1><a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=FT001">胜平负</a><span>|</span><!--<a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=J00013">让球胜平负</a><span>|</span>--><a class="tit-cur">比分</a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=FT003">总进球</a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=FT004">半全场</a></h1>
    	</c:when>
    	<c:when test="${'FT003' eq wanFa }">
    		<h1><a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=FT001">胜平负</a><span>|</span><!--<a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=J00013">让球胜平负</a><span>|</span>--><a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=FT002">比分</a><span>|</span><a class="tit-cur">总进球</a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=FT004">半全场</a></h1>
    	</c:when>
    	<c:when test="${'FT004' eq wanFa }">
    	    <h1><a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=FT001">胜平负</a><span>|</span><!--<a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=J00013">让球胜平负</a><span>|</span>--><a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=FT002">比分</a><span>|</span><a href="${pageContext.request.contextPath }/jcFootballIndex/byJcFootBall?type=1&valueType=1&wanFa=FT003">总进球</a><span>|</span><a class="tit-cur">半全场</a></h1>
    	</c:when>
		<c:when test="${'J00013' eq wanFa }">
    ...
    <form action="${pageContext.request.contextPath }/jcFootball/betDetail" method="post">
    	<p class="prompt-pro">${messageError }</p>
    <h2 class="goucai-title">方案内容</h2>
    <div class="wap-pro-goucai">
    	<!--<c:forEach items="${betCodeViewArray }" var="betCodeView">
    		 <div>
              <p class="zucai"><em>${betCodeView.teamId }.</em>&nbsp;<span>${betCodeView.league }</span>&nbsp;&nbsp;${betCodeView.day }</p>
              <table width="260" border="1" cellspacing="0" cellpadding="0" class="jifen-table playball-table">
                <tr>
                  <td width="110">${betCodeView.homeTeam}(主)</td>
                  <td><span>${betCodeView.letPoint}</span></td>
                  <td width="110">${betCodeView.guestTeam}</td>
                </tr>
              </table>
			  <p class="zucai-kind">投注：<br/>${betCodeView.betCodeView}</p>
       		</div>
    	</c:forEach> -->
