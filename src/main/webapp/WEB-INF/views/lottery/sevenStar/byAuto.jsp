...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h1><a href="${pageContext.request.contextPath }/sevenStarIndex/bySelf">自选</a><span>|</span><a class="tit-cur">机选</a></h1>
    <div class="wap-banner yellowline">
    	<p>每周二、五、日开奖，2元赢取500万！</p>
        <p>代购截止时间：<em class="end-time">${betEndTime }</em></p>
        <p>合买截止时间：<em class="end-time">${heMaiEndTime }</em></p>
        <p class="prompt-pro">${messageError }</p>
    </div>
    <form action="${pageContext.request.contextPath }/sevenStar/byAuto" method="post">
