...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h3><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionFiveSelf" > 直选</a><span>|</span><a class="tittwo-cur">胆拖</a><span>|</span><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionFiveAuto">机选</a></h3>
    <div class="wap-banner">
    	<p>10分钟一期，每天78期。</p>
