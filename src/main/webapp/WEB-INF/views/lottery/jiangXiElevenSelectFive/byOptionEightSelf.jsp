...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h3><a class="tittwo-cur"> 直选</a><span>|</span><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionEightDanTuo">胆拖</a><span>|</span><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionEightAuto">机选</a></h3>
    <div class="wap-banner">
    	<p>10分钟一期，每天78期。</p>
    ...
    <h2 class="goucai-title"><span class="red-ball-num">选择号码：</span>（至少选择8个号码）</h2>
    <div class="wap-pro-goucai">
...
<c:forEach var="item" varStatus="status" begin="1" end="11">
    ...
    <p class="moneey-dlt">任意5个与开奖号码一致即中<span>9</span>元</p>
