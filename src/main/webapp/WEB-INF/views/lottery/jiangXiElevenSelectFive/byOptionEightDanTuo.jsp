...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h1><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionOneSelf" >任一</a><span>|</span><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionTwoSelf">任二</a><span>|</span><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionThreeSelf">任三</a><span>|</span><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionFourSelf">任四</a><span>|</span><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionFiveSelf">任五</a><span>|</span><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionSixSelf">任六</a><span>|</span><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionSevenSelf">任七</a><span>|</span><a class="tit-cur">任八</a></h1>
    <h3><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionEightSelf"> 直选</a><span>|</span><a class="tittwo-cur">胆拖</a><span>|</span><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionEightAuto">机选</a></h3>
    <div class="wap-banner">
    	<p>10分钟一期，每天78期。</p>
    ...
    <h2 class="goucai-title"><span class="red-ball-num">选择胆码：</span>（选择1-7个号码）</h2>
    <div class="wap-pro-goucai">
    ...
    <h2 class="goucai-title"><span class="red-ball-num">选择拖码：</span>（至少选择1个号码，12>胆+拖>8，胆、拖不重复）</h2>
    <div class="wap-pro-goucai">
    	<p class="redball-p no-red">
        	<c:forEach var="item" varStatus="status" begin="1" end="11">
     ...
     <div class="wap-pro-gray-goucai" style="border-top:1px solid #999; border-bottom:none">
     	<input name="ballType" value="R8" type="hidden"/>
