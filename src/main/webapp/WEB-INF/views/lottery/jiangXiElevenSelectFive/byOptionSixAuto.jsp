...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    ...
    <h3><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionSixSelf" > 直选</a><span>|</span><a href="${pageContext.request.contextPath }/jiangXiElevenSelectFiveIndex/byOptionSixDanTuo">胆拖</a><span>|</span><a class="tittwo-cur">机选</a></h3>
