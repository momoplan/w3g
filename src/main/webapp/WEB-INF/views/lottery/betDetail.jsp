    	...
    	<c:choose>
        	...
        	<c:choose>
        		<c:when test="${not empty buyWays }">
            		...
            		<input name="buyWays" type="radio" value="present" class="touzhu-radio" ${'present' eq buyWays ? 'checked':'' }/>我要赠送给他人<br />
        		...
        		<c:otherwise>
            		...
            		<input name="buyWays" type="radio" value="present" class="touzhu-radio" />我要赠送给他人<br />
