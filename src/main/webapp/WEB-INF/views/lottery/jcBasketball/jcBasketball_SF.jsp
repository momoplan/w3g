...
<div class="wap-banner">
     ...
     <c:choose>
     	<c:when test="${'1' eq valueType }">
     		<h3><a href="${pageContext.request.contextPath }/jcBasketballIndex/byJcBasketBall?type=0&valueType=0&wanFa=BSK001">单关</a><span>|</span><a class="tittwo-cur">过关</a></h3>
     		<div class="wap-banner">
    	<p>猜比赛，赢百万奖金！</p>
    ...
    <c:if test="${not empty jcMatchAgainstsMaps }">
    	...
    	<c:forEach items="${jcMatchAgainstsMap.jcMatchAgainsts }" var="jcMatchAgainst">
			...
			<p class="zucai-kind">
			<input name="zhuMa" type="checkbox" value="${jcMatchAgainst.day}|${jcMatchAgainst.weekId}|${jcMatchAgainst.teamId }|0|${jcMatchAgainst.week }|${jcMatchAgainst.league}|${jcMatchAgainst.homeTeam }|VS|${jcMatchAgainst.guestTeam}|主负|(${jcMatchAgainst.peiLv.vs.v0})" class="input-zucai" ${fn:indexOf(zhuMaStr,checkName0)>-1?'checked':'' }/>主负(${jcMatchAgainst.peiLv.vs.v0})&nbsp;&nbsp;
			<input name="zhuMa" type="checkbox" value="${jcMatchAgainst.day}|${jcMatchAgainst.weekId}|${jcMatchAgainst.teamId }|3|${jcMatchAgainst.week }|${jcMatchAgainst.league}|${jcMatchAgainst.homeTeam }|VS|${jcMatchAgainst.guestTeam}|主胜|(${jcMatchAgainst.peiLv.vs.v3})" class="input-zucai" ${fn:indexOf(zhuMaStr,checkName3)>-1?'checked':'' }/>主胜(${jcMatchAgainst.peiLv.vs.v3})</p>
        		</c:when>
        		<c:otherwise>
        		<table width="260" border="1" cellspacing="0" cellpadding="0" class="jifen-table playball-table">
  				<tr>
			...
			<p class="zucai-kind">
			<input name="zhuMa" type="checkbox" value="${jcMatchAgainst.day}|${jcMatchAgainst.weekId}|${jcMatchAgainst.teamId }|0|${jcMatchAgainst.week }|${jcMatchAgainst.league}|${jcMatchAgainst.homeTeam }|VS|${jcMatchAgainst.guestTeam}|主负| " class="input-zucai" ${fn:indexOf(zhuMaStr,checkName0)>-1?'checked':'' }/>主负&nbsp;&nbsp;
			<input name="zhuMa" type="checkbox" value="${jcMatchAgainst.day}|${jcMatchAgainst.weekId}|${jcMatchAgainst.teamId }|3|${jcMatchAgainst.week }|${jcMatchAgainst.league}|${jcMatchAgainst.homeTeam }|VS|${jcMatchAgainst.guestTeam}|主胜| " class="input-zucai" ${fn:indexOf(zhuMaStr,checkName3)>-1?'checked':'' }/>主胜</p>
        		</c:otherwise>
        	</c:choose>
       		</div>
		</c:forEach>
     ...
     <p class="gx-tjiao" style="padding-top:10px;"><strong>选择过关方式：</strong><br /><input type="submit" name="submitType" value="自由过关" class="tz-chakan-btn" /><input type="submit" name="submitType" value="多串过关" class="tz-chakan-btn" style="margin-left:10px;" /></p>
     	...
     	<c:otherwise>
     	    <h3><a class="tittwo-cur">单关</a><span>|</span><a href="${pageContext.request.contextPath }/jcBasketballIndex/byJcBasketBall?type=0&valueType=1&wanFa=BSK001">过关</a></h3>
     		<div class="wap-banner">
    	<p>猜比赛，赢百万奖金！</p>
        <p>销售时间：<em class="end-time">周一/二/五 09:00～22:45 周三/四 07:30～22:45 周六/日 09:00～00:45
	</em></p>
