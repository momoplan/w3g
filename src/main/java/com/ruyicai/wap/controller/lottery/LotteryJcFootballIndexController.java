...
@Controller
@RequestMapping("jcFootballIndex")
public class LotteryJcFootballIndexController {
	private static final Logger logger = Logger
			.getLogger(LotteryJcFootballIndexController.class);
	@Autowired
	 ...
	 * @return
	 */
	@RequestMapping("/byJcFootBall")
	public ModelAndView byJcFootBall(
	...
	@RequestMapping("/byJcFootballToSelect")
	public ModelAndView byJcFootballToSelect(
			@RequestParam(value="type",defaultValue="") String type,
			@RequestParam(value="valueType",defaultValue="") String valueType,
			@RequestParam(value="wanFa",defaultValue="") String wanFa,
	...
	public ModelAndView guoGuan(
		...
		logger.info("LotteryJcFootballIndexController/guoGuan竞彩足球投注内容betCode:"+betCode+",betCodeView:"+betCodeViewArray.toString());
		...
		for(int i=0;i<betCodeViewArray.size();i++){
			...
			+betCodeViewObject.getString("homeTeam")+"(主)</td><td><span>"
			+betCodeViewObject.getString("letPoint")+"</span></td><td width='110'>"
			+betCodeViewObject.getString("guestTeam")+"</td></tr></table><p class='zucai-kind'>投注：<br/>"
	...
	public String getViewName(String wanFa){
		if("FT001".equals(wanFa)) return "jcFootball/jcFootball_SPF";
		if("J00013".equals(wanFa)) return "jcFootball/jcFootball_RQSPF";
		if("FT002".equals(wanFa)) return "jcFootball/jcFootball_BF";
		if("FT003".equals(wanFa)) return "jcFootball/jcFootball_ZJQ";
		if("FT004".equals(wanFa)) return "jcFootball/jcFootball_BQC";
		return "";
	}
	...
	public ModelAndView selectDataAnalysisRanking(
		...
		ModelAndView modelAndView = new ModelAndView();
		Map<String, Object> dataAnalysisMap = lotteryJcUtil.selectDataAnalysis("1", day,weekId, teamId, "ranking");
		...
		modelAndView.setViewName("jcFootball/dataAnalysis_Ranking");
		return modelAndView;
	}
	@SuppressWarnings("unchecked")
	...
	public ModelAndView selectDataAnalysisHistory(
			...
			@RequestParam(value="type",defaultValue="") String type){
		ModelAndView modelAndView = new ModelAndView();
		Map<String, Object> dataAnalysisMap = lotteryJcUtil.selectDataAnalysis("1", day,weekId,teamId, type);
		...
		modelAndView.addObject("type", type);
		modelAndView.addObject("matchMessage", matchMessage);
		modelAndView.setViewName("jcFootball/dataAnalysis_History");
		return modelAndView;
	}
	@SuppressWarnings("unchecked")
	...
	public ModelAndView selectDataAnalysisYaPan(
			...
			@RequestParam(value="teamId",defaultValue="") String teamId){
		ModelAndView modelAndView = new ModelAndView();
		Map<String, Object> dataAnalysisMap = lotteryJcUtil.selectDataAnalysis("1", day,weekId, teamId, "yapan");
		...
		modelAndView.addObject("teamId", teamId);
		modelAndView.addObject("matchMessage", matchMessage);
		modelAndView.setViewName("jcFootball/dataAnalysis_YaPan");
		return modelAndView;
	}
	@SuppressWarnings("unchecked")
	...
	public ModelAndView selectDataAnalysisOuPei(
			...
			@RequestParam(value="teamId",defaultValue="") String teamId){
		ModelAndView modelAndView = new ModelAndView();
		Map<String, Object> dataAnalysisMap = lotteryJcUtil.selectDataAnalysis("1", day,weekId, teamId, "oupei");
		...
		modelAndView.addObject("teamId", teamId);
		modelAndView.addObject("matchMessage", matchMessage);
		modelAndView.setViewName("jcFootball/dataAnalysis_OuPei");
		return modelAndView;
	}
}
