...
public class ValidateGuangDongElevenSelectFiveUtil {
	/**
	 * 验证广东11选5任选自选
	 * @param balls
	 * @param ballType
	...
	public static String validateByOptionSelf(List<String> balls,String ballType,String beiShu,String addNumber){
		...
		if("R8".equals(ballType)&&balls==null) return "选择8个号码！";
		if("R8".equals(ballType)&&balls.size()!=8) return "选择8个号码！";
	...
	public static String validateByAutoOptionSelf(String ballNumber,String ballType){
		...
		if("R8".equals(ballType)&&Integer.parseInt(ballNumber)!=8) return "选择8个号码！";
		return "";
	}
	/**
	 * 验证广东11选5机选
