...
public class LotteryShanDongElevenDuoJinUtil {
	/**
	...
	public static Map<String, String> getOptionSelfBetMap(List<String> balls,String ballType){
		...
		String type = getType(ballType, zhuShu);
		String betCode =type+LotteryUtil.getStringFromStringList(balls)+"^";
		String playType = "";
	...
	public static Map<String, String> getOptionAutoBetMap(String zhuShu,String ballType){
		...
		String type = getType(ballType, 1);
		for(int i=0;i<zhuShuInt;i++){
			...
			betCode += type+LotteryUtil.getStringFromStringList(balls)+"^";
		}
		String playType = "";
		if("R1".equals(ballType)) playType = "任选一";
		if("R2".equals(ballType)) playType = "任选二";
	...
	public static Map<String, String> getDanTuoBetMap(List<String> dballs,List<String> tballs,String ballType){
		...
		String type = getDanTuoType(ballType);
		String betCode = type+LotteryUtil.getStringFromStringList(dballs)+"*"
	...
	public static Map<String, String> getGroupBetMap(List<String> balls,String ballType){
		...
		String type = getGroupType(ballType, zhuShu);
		String betCode =type+LotteryUtil.getStringFromStringList(balls)+"^";
		String playType = "";
	...
	public static Map<String, String> getForwardTwoDirectSelectBetMap(List<String> ball1s,List<String> ball2s){
		...
		String betCode = "";
		String type = getDirectType("Q2", ball1s.size()*ball2s.size());
		betCode = type+LotteryUtil.getStringFromStringList(ball1s)+"*"
	...
	public static Map<String, String> getForwardThreeDirectSelectBetMap(List<String> ball1s,List<String> ball2s,List<String> ball3s){
		...
		String type = getDirectType("Q3", ball1s.size()*ball2s.size()*ball3s.size());
		String betCode = "";
		betCode = type+LotteryUtil.getStringFromStringList(ball1s)+"*"
				+LotteryUtil.getStringFromStringList(ball2s)+"*"
	...
	public static String getType(String ballType,int zhuShu){
		if("R1".equals(ballType)) return "101@*";
		if("R2".equals(ballType)&& zhuShu>1) return "102@*";
		if("R3".equals(ballType)&& zhuShu>1) return "103@*";
		if("R4".equals(ballType)&& zhuShu>1) return "104@*";
		if("R5".equals(ballType)&& zhuShu>1) return "105@*";
		if("R6".equals(ballType)&& zhuShu>1) return "106@*";
		if("R7".equals(ballType)&& zhuShu>1) return "107@*";
		if("R8".equals(ballType)&& zhuShu>1) return "166@*";
		if("Z2".equals(ballType)&& zhuShu>1) return "108@*";
		if("Z3".equals(ballType)&& zhuShu>1) return "109@*";
		if("R2".equals(ballType)&& zhuShu==1) return "111@";
		if("R3".equals(ballType)&& zhuShu==1) return "112@";
		if("R4".equals(ballType)&& zhuShu==1) return "113@";
		if("R5".equals(ballType)&& zhuShu==1) return "114@";
		if("R6".equals(ballType)&& zhuShu==1) return "115@";
		if("R7".equals(ballType)&& zhuShu==1) return "116@";
		if("R8".equals(ballType)&& zhuShu==1) return "117@";
		if("R2".equals(ballType)&& zhuShu==1) return "111@";
		return "";
	}
	public static String getDanTuoType(String ballType){
		if("R2".equals(ballType)) return "121@";
		if("R3".equals(ballType)) return "122@";
		if("R4".equals(ballType)) return "123@";
		if("R5".equals(ballType)) return "124@";
		if("R6".equals(ballType)) return "125@";
		if("R7".equals(ballType)) return "126@";
		if("Z2".equals(ballType)) return "133@";
		if("Z3".equals(ballType)) return "153@";
		return "";
	}
	public static String getGroupType(String ballType,int zhuShu){
		if("Z2".equals(ballType)&&zhuShu==1) return "131@";
		if("Z2".equals(ballType)&&zhuShu>1) return "108@*";
		if("Z3".equals(ballType)&&zhuShu==1) return "151@";
		if("Z3".equals(ballType)&&zhuShu>1) return "109@*";
		return "";
	}
	public static String getDirectType(String ballType,int size){
		if("Q2".equals(ballType)&&size==1) return "142@";
		if("Q2".equals(ballType)&&size>1) return "142@";
		if("Q3".equals(ballType)&&size==1) return "162@";
		if("Q3".equals(ballType)&&size>1) return "162@";
		return "";
	}
}
